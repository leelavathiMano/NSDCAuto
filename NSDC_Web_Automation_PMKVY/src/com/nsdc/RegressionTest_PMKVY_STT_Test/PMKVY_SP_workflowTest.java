...
public class PMKVY_SP_workflowTest extends TestConfiguration {
	...
	public void Addspecialprojectdata_01(String username, String password, String projectproposalID,
			...
			String targetvalue2, String tcName,String tcTarget,String advanceTrancheYes,String advancepayment,String duallogoImg,String review ,String comments,
			String TCloginId,String TCpassword) throws Exception {
...
lp.clickLogin();
	bsp.clickToClose();
	elp.performlogin(username, password);
	db.ClickMySchemeOrPrograms();		ssp.ClickApprovalInProgress_SPAction();
