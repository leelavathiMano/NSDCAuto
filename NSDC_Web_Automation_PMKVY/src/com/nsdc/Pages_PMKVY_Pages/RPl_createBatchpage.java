...
public class RPl_createBatchpage {
...
WebDriver driver;
	...
	public RPl_createBatchpage(WebDriver driver)
	{
		this.driver = driver;
	...
	public void SelectAssociatedQP(String AssociatedQP_JobRole) {
		...
		//SelectDropDownList.selectDropDownListByIndex(AssociatedQP, AssociatedQP_JobRole);
...
//	}
	public void SelectAssessmentLanguage()
	{
...
public void ClickOnBatchOutTIme()
{
	BatchOutTime.click();
}
