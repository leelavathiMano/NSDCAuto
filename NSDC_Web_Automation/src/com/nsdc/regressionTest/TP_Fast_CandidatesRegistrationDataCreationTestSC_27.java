...
<<<<<<< HEAD:NSDC_Web_Automation/src/com/nsdc/regressionTest/TP_Fast_CandidatesRegistrationDataCreation.java
...
//              wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("blockUI.blockOverlay")));
            ...
            driver.findElement(By.xpath("//label[contains(text(),'Candidate Full')]/following::select[1]")).sendKeys("Mr");
...
//          tpCrp.clickToUploadProfilePicture();
            driver.findElement(By.xpath("//input[@id='customFile'][1]")).sendKeys("/Users/apple/Desktop/Screenshot 2019-07-29 at 12.34.16 PM.png");
            driver.findElement(By.xpath("(//button[@type='button'])[1]")).click();
            Thread.sleep(6000);
...
//          tpCrp.enterPlaceOfBirth(placeOfBirth);
            ...
            if(isDisabled.equalsIgnoreCase("yes"))
            {
                ...
                driver.findElement(By.xpath("(//input[@id='customFile'])[2]")).sendKeys("/Users/apple/Desktop/Screenshot 2019-07-29 at 12.34.16 PM.png");
            ...
            if(aadhaarOrAlterternateId.equalsIgnoreCase("aadhaar"))
            {
                ...
                driver.findElement(By.xpath("//label[contains(text(),'Aadhaar Number')]/following::button[2]")).click();
                Thread.sleep(2000);
            }
            else
            {
                ...
                driver.findElement(By.xpath("//label[contains(text(),'Upload ID Proof Copy:')]/following::input[1]")).sendKeys("/Users/apple/Desktop/Screenshot 2019-07-29 at 12.34.16 PM.png");
...
//          tpCrp.selectBoardingAndLodging(boardingAndLodging);
            ...
            driver.findElement(By.xpath("//label[contains(text(),'Year of')]/following::Select[1]")).sendKeys("1980");
            Thread.sleep(2000);
            ...
            driver.findElement(By.xpath("//input[@id='customFile']")).sendKeys("/Users/apple/Desktop/Screenshot 2019-07-29 at 12.34.16 PM.png");
...
>>>>>>> f014c9c7c18cb68790f4e3f65e937ea015943d12:NSDC_Web_Automation/src/com/nsdc/regressionTest/TP_Fast_CandidatesRegistrationDataCreationTestSC_27.java
}