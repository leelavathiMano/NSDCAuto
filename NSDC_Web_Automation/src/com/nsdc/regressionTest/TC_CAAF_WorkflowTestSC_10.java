...
//		}
///////Job Role to Infrastructure & Trainer Mapping:
		
		
//		List<WebElement> RetailSalesChkbx = driver.findElements(By.xpath("(//tbody//tr//td[text()='Retail Sales Associate '])[2]/..//span"));
//		int RetailChkbx = RetailSalesChkbx.size();
//		for(int i=1;i<RetailChkbx;i++)
//		{
//			driver.findElement(By.xpath("((//tbody//tr//td[text()='Retail Sales Associate '])[2]/..//span)["+i+"]")).click();
//		}
//		
		...
		Thread.sleep(3000);
		List<WebElement> chkbx = driver.findElements(By.xpath("//label[@class='m-checkbox m-checkbox--default']/span"));
