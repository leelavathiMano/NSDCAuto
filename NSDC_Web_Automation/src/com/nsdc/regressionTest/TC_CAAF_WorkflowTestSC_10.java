...
//				datc.clickOnReview();
	...
	public void approveSchemeUnderTC_05(String sno, String tc_ID, String password, String tc_Name, String tc_Type, String ha_Username, String recommendationLetter, String ia_Username, String stage, String assignTo, String daUsername, String menResidential, String womenResidential, String address_ReviewComments, String approachRoad_ReviewComments, String menResidential_ReviewComments, String womenResidential_ReviewComments, String diffrentlyAbledFacilities_ReviewComments, String hygiene_ReviewComments, String medical_ReviewComments, String reviewComments, String finalStatus, String finalReviewComments, String finalStatusFile, String pmkkSPOKEUsername, String sector, String jobRoleName, String scheme, String schemeFile, String sa_Username,  String city, String Country, String paymentMethod, String creditCardNumber, String month_CreditCard, String year_CreditCard, String cvv_CreditCard, String debitCardNumber, String month_DebitCard, String year_DebitCard, String cvv_DebitCard, String bankName,String ci_Username, String inspectionDate, String qc_Username, String centreStatus, String centreComment, String centreStatusFile, String jobRoleStatus, String jobRoleComment, String jobRoleStatusFile, String ssc_Username, String trainerTOTCertified, String trainerNEISBUDCertified, String sscFinalReview, String sscReviewFile, String sscFinalReviewComments, String assignTo_CM, String tcComment, String tcCommentFile, String sscFinalReview_Second, String sscFinalReviewComments_Second) throws Exception
	{
			...
			Thread.sleep(3000);
			//scheme = driver.findElement(By.xpath("//select[@formcontrolname='name']")).getText();
			//ReadWriteData.setExcelData("./TestData/Workflow/TC_CAAF-Workflow.xls", "TCApprovalSC15TC04", Integer.parseInt(sno), 27, scheme);
			Thread.sleep(3000);
			tcm.clickOnSubmit();
			Thread.sleep(3000);
			tcm.clickOnOK();
			//Assert.assertEquals(driver.findElement(By.xpath("//tr[td[span[contains(text(),'"+jobRoleName+"')]]]//span[text()='"+scheme+"']")).getText(), scheme);
...
//					Thread.sleep(3000);
	...
	public void inspectionOfTC_05(String sno, String tc_ID, String password, String tc_Name, String tc_Type, String ha_Username, String recommendationLetter, String ia_Username, String stage, String assignTo, String daUsername, String menResidential, String womenResidential, String address_ReviewComments, String approachRoad_ReviewComments, String menResidential_ReviewComments, String womenResidential_ReviewComments, String diffrentlyAbledFacilities_ReviewComments, String hygiene_ReviewComments, String medical_ReviewComments, String reviewComments, String finalStatus, String finalReviewComments, String finalStatusFile, String pmkkSPOKEUsername, String sector, String jobRoleName, String scheme, String schemeFile, String sa_Username,  String city, String Country, String paymentMethod, String creditCardNumber, String month_CreditCard, String year_CreditCard, String cvv_CreditCard, String debitCardNumber, String month_DebitCard, String year_DebitCard, String cvv_DebitCard, String bankName,String ci_Username, String inspectionDate, String qc_Username, String centreStatus, String centreComment, String centreStatusFile, String jobRoleStatus, String jobRoleComment, String jobRoleStatusFile, String ssc_Username, String trainerTOTCertified, String trainerNEISBUDCertified, String sscFinalReview, String sscReviewFile, String sscFinalReviewComments, String assignTo_CM, String tcComment, String tcCommentFile, String sscFinalReview_Second, String sscFinalReviewComments_Second) throws Exception
	{				
	...
	public void qcApprovalOfTC_05(String sno, String tc_ID, String password, String tc_Name, String tc_Type, String ha_Username, String recommendationLetter, String ia_Username, String stage, String assignTo, String daUsername, String menResidential, String womenResidential, String address_ReviewComments, String approachRoad_ReviewComments, String menResidential_ReviewComments, String womenResidential_ReviewComments, String diffrentlyAbledFacilities_ReviewComments, String hygiene_ReviewComments, String medical_ReviewComments, String reviewComments, String finalStatus, String finalReviewComments, String finalStatusFile, String pmkkSPOKEUsername, String sector, String jobRoleName, String scheme, String schemeFile, String sa_Username,  String city, String Country, String paymentMethod, String creditCardNumber, String month_CreditCard, String year_CreditCard, String cvv_CreditCard, String debitCardNumber, String month_DebitCard, String year_DebitCard, String cvv_DebitCard, String bankName,String ci_Username, String inspectionDate, String qc_Username, String centreStatus, String centreComment, String centreStatusFile, String jobRoleStatus, String jobRoleComment, String jobRoleStatusFile, String ssc_Username, String trainerTOTCertified, String trainerNEISBUDCertified, String sscFinalReview, String sscReviewFile, String sscFinalReviewComments, String assignTo_CM, String tcComment, String tcCommentFile, String sscFinalReview_Second, String sscFinalReviewComments_Second) throws Exception
	{				
...
//						}
				...
				for(int i=0;i<elements.size();i++)
					{
						...
						List<WebElement> ele2 = driver.findElements(By.xpath("//div[div[div[div[h3[contains(text(),'Job Role Name(QPCode)')]]]]]//select[option[text()='Select Review Comments']]"));
						{
								...
								for(int j=0;j<ele2.size();j++)
								{
									...
									if(j==3)
									{
										List<WebElement> img = driver.findElements(By.xpath("//div[div[div[div[h3[contains(text(),'Job Role Name(QPCode)')]]]]]//figure"));
										for(int k=0; k<10; k++)
										{
		...
		//			datr.clickOnNext_ForJobRole();
					...
					for(int i=0; i<ele3.size(); i++)
					{
						...
						js.executeScript("scroll(0, 1200)");
						Thread.sleep(5000);
						driver.findElement(By.xpath("(//div[div[div[h4[contains(text(),'Centre Area Type')]]]]//figcaption[text()='TC Image'])["+(i+1)+"]")).click();
						Thread.sleep(3000);
						FilePreview.closeWindow(driver);
						Thread.sleep(5000);
						driver.findElement(By.xpath("(//div[div[div[h4[contains(text(),'Centre Area Type')]]]]//figcaption[text()='TC Image'])["+(i+2)+"]")).click();					
						Thread.sleep(3000);
						FilePreview.closeWindow(driver);
						js.executeScript("scroll(0, 1200)");
						Thread.sleep(8000);
						driver.findElement(By.xpath("(//div[div[div[h4[contains(text(),'Centre Area Type')]]]]//figcaption[text()='CI Image'])["+(i+1)+"]")).click();
						Thread.sleep(3000);
						FilePreview.closeWindow(driver);
						Thread.sleep(5000);
						driver.findElement(By.xpath("(//div[div[div[h4[contains(text(),'Centre Area Type')]]]]//figcaption[text()='CI Image'])["+(i+2)+"]")).click();					
						Thread.sleep(3000);
						FilePreview.closeWindow(driver);
					}
					Thread.sleep(3000);
	...
	public void tcAccrediatedFromSSC_06(String sno, String tc_ID, String password, String tc_Name, String tc_Type, String ha_Username, String recommendationLetter, String ia_Username, String stage, String assignTo, String daUsername, String menResidential, String womenResidential, String address_ReviewComments, String approachRoad_ReviewComments, String menResidential_ReviewComments, String womenResidential_ReviewComments, String diffrentlyAbledFacilities_ReviewComments, String hygiene_ReviewComments, String medical_ReviewComments, String reviewComments, String finalStatus, String finalReviewComments, String finalStatusFile, String pmkkSPOKEUsername, String sector, String jobRoleName, String scheme, String schemeFile, String sa_Username,  String city, String Country, String paymentMethod, String creditCardNumber, String month_CreditCard, String year_CreditCard, String cvv_CreditCard, String debitCardNumber, String month_DebitCard, String year_DebitCard, String cvv_DebitCard, String bankName,String ci_Username, String inspectionDate, String qc_Username, String centreStatus, String centreComment, String centreStatusFile, String jobRoleStatus, String jobRoleComment, String jobRoleStatusFile, String ssc_Username, String trainerToTCertified, String trainerNEISBUDCertified, String sscFinalReview, String sscReviewFile, String sscFinalReviewComments, String assignTo_CM, String tcComment, String tcCommentFile, String sscFinalReview_Second, String sscFinalReviewComments_Second) throws Exception
		...
		//	ssca.clickOnApply();
			...
			Thread.sleep(3000);
			List<WebElement> eqp = driver.findElements(By.xpath("//div[div[label[contains(text(),'Equipment Details')]]]//label[input[@formcontrolname='markVerified']]"));
			for(int i=0; i<eqp.size(); i++)
			{
			...
			else if(((trainerToTCertified.equals("Yes")) && (trainerNEISBUDCertified.equals("No")) || ((trainerToTCertified.equals("No")) && (trainerNEISBUDCertified.equals("Yes")))))
			{
				Thread.sleep(3000);
				ssca.clickOnTOTCertifiedTrainer_Yes();
				Thread.sleep(3000);
