...
public class FeeBased_AddSchemeWorkflowTestSC_14 extends TestConfiguration
{
	...
	@Test(dataProvider="resubmitAndReviewScheme")
	public void resubmitAndReviewSchemeTC_03(String srno, String tpusername, String tppassword, String daComments, String daReviewComments, String newStartDate, String newEndDate, String newProjectID, String oldProjectName, String newProjectName, String newProposedOrganisation, String newImplementingOrganisation, String newFinancialModelType, String newFundedBy, String newProjectTarget, String newPromoterDetails, String newSanctionLoanAmount, String newMoratoriumPeriod, String newLoanDuration, String newInterestRate, String newSignedTermsheetFile, String newSignedProposalFile, String newOtherSupportingFile, String newSector, String newGTrainingTarget, String newAddSectorUndertakingFile, String newaffiliationCertificate, String newCourseName, String newSector_AddCourse, String newJobRole, String newJobRoleName, String newnsqfLevel, String newCourseDescription, String newCertificateName, String newMinimumAge, String newMinimumEducation, String newCourseDuration, String newNumberOfHours, String newCourseFee, String newGradingPrefrences, String newCourseApprovalFile, String newAffiliationFile, String newWorkOrderFile, String newChallanFile, String newStampPaper, String state, String district, String fDausername, String fDApassword, String newState, String newDistrict, String newComment, String newReviewComment) throws Exception
	{
		LoginPage lp = new LoginPage(driver);
		lp.clickLogin();
		EnterLoginPage elp = new EnterLoginPage(driver);
		...
		if(daComments.equals("Recommended"))
		{
			...
			driver.findElement(By.xpath("//a[contains(text(),'View Details')]")).click();
			Thread.sleep(3000);
			Assert.assertEquals(driver.findElement(By.xpath("//tr[td[div[span[text()='"+oldProjectName+"']]]]//span[text()='Approved']")).getText(), "Approved");
		}
		else if(daComments.equals("Not Recommended"))
		{
			Thread.sleep(3000);
			...
			driver.findElement(By.xpath("//a[contains(text(),'View Details')]")).click();
			Thread.sleep(3000);
			Assert.assertEquals(driver.findElement(By.xpath("//tr[td[div[span[text()='"+oldProjectName+"']]]]//span[text()='Rejected']")).getText(), "Rejected");
		}
		else if(daComments.equals("Document Required"))
		{
			Thread.sleep(3000);
			...
			driver.findElement(By.xpath("//a[contains(text(),'View Details')]")).click();
			Thread.sleep(3000);
			Assert.assertEquals(driver.findElement(By.xpath("//tr[td[div[span[text()='"+oldProjectName+"']]]]//span[text()='Send Back']")).getText(), "Send Back");
			Thread.sleep(3000);
			driver.findElement(By.xpath("//tr[td[div[span[text()='"+oldProjectName+"']]]]//a[@class='btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill']")).click();
			Thread.sleep(3000);
			driver.findElement(By.xpath("//tr[td[div[span[text()='"+oldProjectName+"']]]]//a[contains(text(),'View Details')]")).click();
			TP_FeeBasedProgramPage tpfb = new TP_FeeBasedProgramPage(driver);
			Thread.sleep(3000);
			//tpfb.clickOnCloseButton();
			Thread.sleep(3000);
			...
			ReadWriteData.setExcelData("./TestData/Workflow/TP_MyScheme-Workflow.xls", "MySchemeAddSector&CoursSC15TC04", Integer.parseInt(srno), 3, newProjectName);
			ReadWriteData.setExcelData("./TestData/Workflow/TP_MyScheme-Workflow.xls", "ResubmitAndReviewTCSC15TC03", Integer.parseInt(srno), 3, newProjectName);
			ReadWriteData.setExcelData("./TestData/Workflow/TP_MyScheme-Workflow.xls", "TPFeeBasedLinkTrainerSC15TC06", Integer.parseInt(srno), 3, newProjectName);
			ReadWriteData.setExcelData("./TestData/Workflow/TP_MyScheme-Workflow.xls", "AddAssessmentAgencySC15TC07", Integer.parseInt(srno), 3, newProjectName);
			...
			if(newJobRole.equals("QP-NOS"))
			{
				...
				tpfb.selectAssociatedQP_JobRoleNameI(newJobRoleName);
				newnsqfLevel = driver.findElement(By.xpath("(//input[@ng-reflect-name='nsqfLevel'])[2]")).getAttribute("value");
				ReadWriteData.setExcelData("./TestData/Workflow/FeeBased_AddScheme-Workflow.xls", "FeeBasedAddSchemeSC14TC03", Integer.parseInt(srno), 31, newnsqfLevel);
				tpfb.enterCourseDescription(newCourseDescription);
				tpfb.enterNameOfIssuedCertificate(newCertificateName);
				tpfb.selectMinimumAge(newMinimumAge);
				tpfb.selectMinimumEducationRequired(newMinimumEducation);
			...
			driver.findElement(By.xpath("//a[contains(text(),'View Details')]")).click();
			Thread.sleep(3000);
			Assert.assertEquals(driver.findElement(By.xpath("//tr[td[div[span[text()='"+newProjectName+"']]]]//span[text()='Resubmitted']")).getText(), "Resubmitted");
			PostLoginPage plp = new PostLoginPage(driver);
			Thread.sleep(3000);
			plp.clickOnProfileLogo();
			plp.clickOnLogout();
			...
			frp.clickOnApply();
			Thread.sleep(4000);
			//driver.findElement(By.xpath("//tr[td[span[text()='"+tpusername+"']]]//a[@class='btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill']")).click();
			//driver.findElement(By.xpath("//tr[td[span[text()='"+tpusername+"']]]//a[contains(text(),'Take Action')]")).click();
			List <WebElement> button = driver.findElements(By.xpath("//tr[td[div[span[text()='"+tpusername+"']]]]//a[@class='btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill']"));
			int size = button.size();
			WebElement ele = button.get(size-1);
			ele.click();
			List <WebElement> ta = driver.findElements(By.xpath("//tr[td[div[span[text()='"+tpusername+"']]]]//a[contains(text(),'Take Action')]"));
			int size1 = ta.size();
			WebElement tab = ta.get(size1-1);
			tab.click();
			FDA_SelectedSchemePage fss = new FDA_SelectedSchemePage(driver);
			...
			{
				Thread.sleep(3000);
				Assert.assertEquals(driver.findElement(By.xpath("(//tr[td[div[span[text()='"+tpusername+"']]]]//span[text()='APPROVED'])[1]")).getText(), "APPROVED");
			}
			else if(newComment.equals("Not Recommended"))
			{
				Thread.sleep(3000);
				Assert.assertEquals(driver.findElement(By.xpath("(//tr[td[div[span[text()='"+tpusername+"']]]]//span[text()='BLOCKED'])[1]")).getText(), "BLOCKED");
			}
			else if(newComment.equals("Document Required"))
			{
				Thread.sleep(3000);
				Assert.assertEquals(driver.findElement(By.xpath("(//tr[td[div[span[text()='"+tpusername+"']]]]//span[text()='REJECTED'])[1]")).getText(), "REJECTED");
			}
		}
		PostLoginPage plp = new PostLoginPage(driver);
		Thread.sleep(3000);
...
public void acceptBatchTC12(String sno, String aaUserName, String aaPassword, String username_SSC, String password_SSC, String batchID, String tpUsername, String tpPassword, String projectName, String tcName, String certificateFile, String offerLetter, String appointmentLetter, String salarySlip)throws Exception
{
