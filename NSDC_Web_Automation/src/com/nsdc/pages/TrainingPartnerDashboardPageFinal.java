...
public class TrainingPartnerDashboardPageFinal 
{
	WebDriver driver;
	...
	@FindBy(xpath="//p[text()='View My Candidates']")
	private WebElement ViewMyCandidates;
	...
	public TrainingPartnerDashboardPageFinal(WebDriver driver)
    {
        this.driver = driver;
	...
	public void clickOnViewMyCandidate()
	{
		ViewMyCandidates.click();
	}
