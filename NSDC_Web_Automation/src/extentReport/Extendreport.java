...
public class Extendreport extends TestConfiguration
	 {
	 	@DataProvider
		...
		String otherDocument)throws Exception
	 	{
	 		...
	 		//ExtentHtmlReporter ehreporter=new ExtentHtmlReporter("./ExtendReport/SSC_CreateNos.xls");
	 		//ExtentReports extent= new ExtentReports();
	 		             // extent.attachReporter(ehreporter);
	 		//ExtentTest Qpnos = extent.createTest("QpNOSWorkFlowTest_23");
	 		
	 		//Qpnos.log(Status.INFO, "create Nos data");
	 		//Qpnos.log(Status.PASS, " Nos create successfully");
	 		//Qpnos.addScreenCaptureFromPath("./Screenshots/Create_QpNos");
	 		//extent.flush();
