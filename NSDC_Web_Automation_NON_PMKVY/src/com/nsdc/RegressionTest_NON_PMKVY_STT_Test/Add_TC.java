...
public class Add_TC extends TestConfiguration {
	...
	public void addTrainingCentreTC04(String sno, String tpUsername, String tpPassword, String projectName,
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("//tr[td[span[span[text()='" + projectName
				+ "']]]]//a[@class='btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill']")).click();
		driver.findElement(
				By.xpath("//tr[td[span[span[text()='" + projectName + "']]]]//a[contains(text(),'View Details')]"))
				.click();
		...
		if (ownership.equals("Franchise")) {
			...
			driver.findElement(By.xpath("//input[@placeholder='Select Effective Date']")).getAttribute("value");
			...
			// endDate =driver.findElement(By.xpath("//input[@placeholder='Select Close
			...
			// startDate =driver.findElement(By.xpath("//input[@placeholder='Select
			// Effective Date']")).getAttribute("value"); 
		...
		Thread.sleep(3000); // fbad.clickOnOK();
		Thread.sleep(8000);
		fbd.clickOnViewTrainingCentres();

		Assert.assertEquals(driver
				.findElement(By
						.xpath("(//tr[td[span[span[text()='Training Centre 1']]]]//span[text()='Profile Pending'])[1]"))
				.getText(), "Profile Pending");
