...
public class TP_FeeBased_BatchDetailsPage 
{
	...
	@FindBy(xpath="//select[@formcontrolname='skillingcategory']")
	private WebElement SkillingcategoryDropdownlist;
	...
	public void SelectSkillingcategory(String Skillingcategory)
	{
		SelectDropDownList.selectDropDownListByVisibleText(SkillingcategoryDropdownlist, Skillingcategory);
	}
	public void clickOnStartDate_BatchDuration()throws Exception
	{
		startDate_BatchDurationTextbox.click();
		Thread.sleep(3000);
		startDate_BatchDurationTextbox.sendKeys(Keys.ENTER, Keys.TAB);
	}
	
	public void clickOnEndDate_BatchDuration()throws Exception
	{
		Thread.sleep(3000);
		endDate_BatchDurationTextbox.sendKeys(Keys.ARROW_DOWN, Keys.ARROW_DOWN, Keys.ARROW_DOWN,Keys.ARROW_DOWN, Keys.ENTER, Keys.TAB);
	}
	...
	{
		Thread.sleep(5000);
		endDate_TrainingDurationTextbox.sendKeys(Keys.ARROW_DOWN, Keys.ARROW_DOWN, Keys.ARROW_DOWN,Keys.ARROW_DOWN,Keys.ARROW_DOWN, Keys.ARROW_DOWN, Keys.ARROW_DOWN, Keys.ARROW_DOWN, Keys.ARROW_DOWN, Keys.ENTER, Keys.TAB);
	}
